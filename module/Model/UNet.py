...
from module.Model.util.blocks import get_time_embedding
from module.Model.util.blocks import DownBlock, MidBlock, UpBlockUnet
...
class UNet(nn.Module):
    ...
    def __init__(self, im_channels, model_config):
        ...
        self.digit_num_classes = self.condition_config['digit_condition_config']['num_classes']
        # Rather than using a special null class we dont add the
        # class embedding information for unconditional generation
        self.digit_emb = nn.Embedding(self.digit_num_classes, self.t_emb_dim)
    ...
    def forward(self, x, t, cond_input=None):
        ...
        ######## Class Conditioning ########
        digit_embed = einsum(cond_input['digit_label'].float(), self.digit_emb.weight, 'b n, n d -> b d')
        t_emb += digit_embed
        ####################################
